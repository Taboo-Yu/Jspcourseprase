			...
			<!-- 
			 ...
			 -->
				...
				<a href="${basePath}home.jsp?page=showGoods&type=shuiguo"  target="content">
					水果</a>
				<div style="width: 269px; height: 50px;float:right;">
				<a >made by :俞涛，陈池，顾凯翔</a>	
				</div>
			</div>
    ...
    if(type === 'bar1'){
      layer.open({
		id: 'menu',
	 	...
	 	"<a href='${basePath}home.jsp?page=showGoods&type=cai'  target='content'>美味 </a><br>"+
		"<a href='${basePath}home.jsp?page=showGoods&type=cai' target='content'>甜品 </a><br>"+
		"<a href='${basePath}home.jsp?page=showGoods&type=cai'  target='content'>水果</a>",
	 	skin: 'open-class',
	    area: ['120px','180px'],
	    offset: ['100px', '55px'],
     	btnAlign: 'c',
