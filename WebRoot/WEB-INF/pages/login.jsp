		...
		<div class="fly-panel fly-panel-user" style="background-color: rgba(255, 255, 255, 0.8);" pad20>
			<div class="layui-tab layui-tab-brief">
				<ul class="layui-tab-title">
					<li><a href="${basePath}register.jsp?page=registerPage">注册</a></li>
					...
					<div class="layui-tab-item layui-show">
						<div class="layui-form layui-form-pane">
							<form method="post">
								...
								<div class="layui-form-item">
									<span style="padding-left:20px;"> <a href="mailto:1343089310@qq.com">忘记密码？</a>
									</span>
									<br>
									<button onclick="doLogin()" type="button" style="margin-left:111px;" class="layui-btn" id="loginSubmit" lay-filter="*">立即登录
									</button>
								</div>
							</form>
						</div>
